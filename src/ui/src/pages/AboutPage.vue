    ...
    >
      ...
      <section class="space-y-4">
        ...
        <p class="text-gray-300 leading-relaxed">
          ...
          <strong class="text-gray-200">CatMeows</strong>, a dataset of domestic
          cat meows recorded in three everyday situations: waiting for food,
          social grooming (brushing), and short-term isolation in an unfamiliar
          space. Recordings come from pedigreed European Shorthairs and Maine
          Coons, so breed and sex metadata travel with the waveforms. The
          dataset is released under a Creative Commons licence on Zenodo
          (<a
            :href="zenodoCatMeows"
          ...
          >), which makes it possible for tools like ours to ship reproducible,
          citeable behaviour instead of anonymous sound effects.
        </p>
        <p class="text-gray-300 leading-relaxed">
          ...
          situations apart from the sound alone—supporting the idea that
          “what the meow is for” is partly encoded in the vocal signal, not
          only in the cat’s body language. Meowsformer uses that intuition:
          recording context and continuous
          <strong class="text-gray-200">valence</strong> (pleasantness) and
          <strong class="text-gray-200">arousal</strong> (activation) coordinates
          anchor our tags in an affective space related to Russell’s circumplex
          model, adapted for downstream audio matching.
        </p>
      </section>
      ...
      <section class="space-y-4">
        ...
        <p class="text-gray-300 leading-relaxed">
          ...
          University (Sweden) applies phonetic and multimodal methods to how cats
          and people vocalise during interaction—“melody in human–cat
          communication.” Their report and associated materials document rigorous
          recording and annotation practice for real-world cat sounds beyond a
          single lab paradigm
          (<a
            :href="meowsicPortal"
            class="text-meow-400 underline decoration-meow-500/50 hover:text-meow-300"
          ...
          >). We cite this line of work because it shares Meowsformer’s premise:
          cat vocalisations are structured signals worth measuring, not
      ...
      <section class="space-y-4">
        ...
        <p class="text-gray-300 leading-relaxed">
          ...
          <strong class="text-gray-200">target tag set</strong>, not for a clip
          ID. A dedicated matcher then scores every indexed sample with a
        ...
        >
          <li>
            ...
            inferred from scenario and valence–arousal rules (e.g. anticipation
            vs distress).
          </li>
          <li>
          ...
          <li>
            <strong class="text-gray-200">Breed voice</strong> — timbre and breed
            metadata so preferences can nudge the match toward a plausible
            voice type.
          </li>
        </ul>
        <p class="text-gray-300 leading-relaxed">
          Emotion and intent currently carry the largest weights in the overall
          score; acoustic and social context are secondary; breed voice adds a
          smaller, tunable bias. The outcome is a transparent ranking: you can
          inspect tags and scores instead of trusting a black box that might
          secretly roll dice.
        </p>
      </section>
        ...
        <dl class="space-y-5">
          <div>
            ...
            <dd class="mt-1 text-gray-300 leading-relaxed">
              ...
              tags often map this to demanding or eager affect with solicitation
              intent.
            </dd>
          </div>
          <div>
            ...
            <dd class="mt-1 text-gray-300 leading-relaxed">
              Isolation recordings are associated with more negative valence and
              vocalisations people describe as uneasy or complaining. That
              aligns with anxious or distressed emotional tags rather than
              relaxed grooming talk.
            </dd>
          </div>
          <div>
            <dt class="font-medium text-meow-300">Brushing or calm handling</dt>
            <dd class="mt-1 text-gray-300 leading-relaxed">
              ...
              comfort vs annoyance using valence and arousal-shaped tag sets, so
              the matched meow should reflect that nuance when the transcript is
              clear.
            </dd>
          </div>
          <div>
            ...
            <dd class="mt-1 text-gray-300 leading-relaxed">
              ...
              and engineering choices described on this page. If your cat shows
              sudden vocal or behaviour changes, ask a qualified veterinarian.
            </dd>
          </div>
        </dl>
      </section>
